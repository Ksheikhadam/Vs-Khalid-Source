...
class Preloader extends FlxBasePreloader
{
    ...
    override function create(new(!Bitmap/LogoImage)):Void; 
    {
        ...
        logo = new Sprite();
        logo.addChild(new Bitmap(new LogoImage(16,17))); //Sets the graphic of the sprite to a Bitmap object, which uses our embedded BitmapData class.
